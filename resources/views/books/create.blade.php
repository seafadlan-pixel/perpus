                ...
                <form action="{{ route('books.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="publisher" class="form-control" placeholder="Masukkan penerbit" required>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="stock" class="form-control" placeholder="Jumlah stok awal" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="category" class="form-control" placeholder="Contoh: Fiksi, Sains, Sejarah">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Language</label>
                            <input type="text" name="language" class="form-control" placeholder="Contoh: Indonesia, Inggris">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">ISBN</label>
                            <input type="text" name="isbn" class="form-control" placeholder="Masukkan kode ISBN jika ada">
                        </div>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Cover Image URL</label>
                        <input type="url" name="cover_image" class="form-control" placeholder="https://example.com/image.jpg">
                        <small class="text-muted" style="font-size: 0.75rem;">Masukkan URL gambar sampul buku (opsional).</small>
                    </div>

                    <div class="mb-4">
                        <label class="form-label">Synopsis</label>
                        <textarea name="synopsis" class="form-control" rows="5" placeholder="Tuliskan sinopsis singkat mengenai buku..."></textarea>
                    </div>
